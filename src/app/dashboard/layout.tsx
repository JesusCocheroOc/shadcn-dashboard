...
export default function DashboardLayout({
    ...
    return (
        <>
            {/*/// con la etiqueta dark: podemos asignar propiedades para cuando este en ese modo si no tomara las clases por defecto  */}
                                ...
                                <ul className='space-y-2 pb-2'>
                                    {links.map((link) => (
                                        <li key={link.href}>
                                            <Link
                                                href={link.href}
                                                className='text-base capitalize text-gray-900 dark:text-gray-200 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:hover:bg-slate-800'
                                            >
                                                <span className='ml-3'>
                                                    {link.name}
                                                </span>
                    ...
                    <main>
                        <div className='pt-6 px-4'>
                            <div className='w-full min-h-[calc(100vh-230px)]'>
                                <div className='bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 dark:border-slate-700 dark:bg-black'>
                                    {children}
                                </div>
                            </div>
                        </div>
                    </main>
                    {/*/// clase de tailwind para cuando queramos imprimir pantalla no se visualice, print:hidden  */}
                    <footer className='print:hidden bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 dark:bg-slate-900 dark:border-slate-200'>
